                                    ...
                                    <div class="col-auto col-md-7">
                                        <div class="media flex-column flex-sm-row">
                                            ...
                                            <div class="media-body  my-auto">
                                                <div class="row ">
                                                    <div class="col"><small class="mb-0"> <b> product.prodName  </b> </small> <img class=" img-fluid " src="https://i.imgur.com/6oHix28.jpg" width="62" height="62"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="pl-0 flex-sm-col col-auto my-auto"><p><b>product.prodPrice</b></p> x</div>
                                </div>
                                </div>
                            </div>
                        </div>
